...
<p> <?php readfile("../Missal/introductoryRites.html"); ?> </p>
    ...
    <p> Kyrie </p>
    <p> ♫ Gloria ♫ </p>
    <p> Let us Pray. <?php readfile("../lectionary/ThirteenthSundayinOrdinaryTime_collect.html"); ?> </p>
    <p> <h2>The Liturgy of the Word</h2> </p>
    <p> A reading from </p>
    <p> <?php readfile("../lectionary/ThirteenthSundayinOrdinaryTime_r1.html"); ?> </p>
    <p> The Word of the Lord. R. Thanks be to God. </p>
    <p> ♫ <?php echo $_POST[respPsalm]; ?> ♫ </p>
    <p> A reading from </p>
    <p> <?php readfile("../lectionary/ThirteenthSundayinOrdinaryTime_r2.html"); ?></p>
    <p> The Word of the Lord. R. Thanks be to God.</p>
    ...
    <p> <?php readfile("../lectionary/ThirteenthSundayinOrdinaryTime_gospel.html"); ?> </p>
