...
<p> <?php readfile("../Missal/introductoryRites.html"); ?> </p>
    <p> Opening remarks</p>
    <p> Greeting </p>
    <p> Penitential Act </p>
    <p> Kyrie </p>
    <p> ♫ Gloria ♫ </p>
    <p> Let us Pray. <?php readfile("../lectionary/TwelfthSundayinOrdinaryTime_collect.html"); ?> </p>
    <p> <h2>The Liturgy of the Word</h2> </p>
    <p> A reading from </p>
    <p> <?php readfile("../lectionary/TwelfthSundayinOrdinaryTime_r1.html"); ?> </p>
    <p> The Word of the Lord. R. Thanks be to God. </p>
    <p> ♫ <?php echo $_POST[respPsalm]; ?> ♫ </p>
    <p> A reading from </p>
    <p> <?php readfile("../lectionary/TwelfthSundayinOrdinaryTime_r2.html"); ?></p>
    <p> The Word of the Lord. R. Thanks be to God.</p>

    <!-- <p>  <?php /* readfile("../lectionary/Pentecost_seq.html"); */ ?> </p> -->
    ...
    <p> <?php readfile("../lectionary/TwelfthSundayinOrdinaryTime_gospel.html"); ?> </p>
    ...
    <p> <?php /* readfile("../lectionary/SolemnityoftheBodyandBloodofChrist_preface.html"); */ ?> </p>
