...
<meta name="LastModified" content="02/10/2022">
...
<div class="row">
 ...
 <div class="row">
      ...
      <div class="col-75">
        <textarea id="Opening" wrap="soft" name="Opening" placeholder="e.g. Hello and welcome to Holy Redeemer........" style="height:100px"></textarea>
      </div>
    </div>    
    ...
    <div class="row">
      ...
      <div class="col-75">
        <textarea id="entranceA" name="entranceA" wrap="hard" placeholder="Entrance Hymn if sung, otherwise leave blank for spoken antiphon/.." ></textarea>
      </div>
    </div>
